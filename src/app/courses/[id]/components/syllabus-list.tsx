        ...
        return (
          <div
            ...
            className={cn(
              ...
              isEnrolled ? "cursor-pointer" : "opacity-75 cursor-default",
          ...
          >
            <div className="flex items-center gap-3.5">
              ...
              <div className="space-y-0.5">
                <p className={cn("text-xs font-extrabold leading-tight", isCurrent && isEnrolled ? "text-primary" : "text-foreground")}>
                  {lesson.title}
                </p>
