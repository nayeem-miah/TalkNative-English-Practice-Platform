...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon className="pointer-events-none w-3.5 h-3.5 text-primary" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
